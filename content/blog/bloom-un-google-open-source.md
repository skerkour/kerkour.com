...
Pour proposer un début de solution aux enjeux inédits de notre siècle j'ai créé une alternative gratuite,
libre et open source à Google (et sans pubs / tracking).
C'est par [ici pour la version en ligne](https://bloom.sh), par [ici pour le code](https://github.com/bloom42)
et par [ici pour contribuer / aider]().
