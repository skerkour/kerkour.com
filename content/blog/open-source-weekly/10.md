...
As you may have noticed I have updated the website (from [opensourceweekly.org](https://opensourceweekly.org/) to [kerkour.fr](https://kerkour.fr/)) because it was too much of a burden for me to maintain 2 websites.<br />
**If you use an RSS reader, please update your feed to: [https://kerkour.fr/feed.xml](https://kerkour.fr/feed.xml)** <br />
...
![image alt text](https://kerkour.fr/open-source-weekly/10/decentralized.jpg)
