...
Contact: <span id="email">Javascript is required to access email address</span> (I respond to emails each wednesday and sunday. Do not expect a response the other days).
