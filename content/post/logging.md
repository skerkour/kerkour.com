...
I created the framework [Astroflow](https://astrocorp.net/astroflow) which will have implementations for all the languages I use (contributions are welcome for other languages!) with respect to the above principles.
